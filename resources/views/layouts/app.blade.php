...
<head>
    ...
    @vite(['public/bacckend/assets/vendors/core/core.css'])
    <!-- endinject -->
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="general-pages">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('users.create') }}" class="nav-link">Create a new user</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#geges" role="button" aria-expanded="false"
                            aria-controls="geges">
                            <i class="link-icon" data-feather="book"></i>
                            <span class="link-title">category</span>
                            <i class="link-arrow" data-feather="chevron-down"></i>
                        </a>
                        <div class="collapse" id="geges">
                            <ul class="nav sub-menu">
                                @if (auth()->user()->role === 'admin')
                                    <li class="nav-item">
                                        <a href="{{ route('category.create') }}" class="nav-link">Create a new
                                            category</a>
                                    </li>
                                @endif
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="tag">
                            <ul class="nav sub-menu">
                                @if (auth()->user()->role === 'admin')
                                    <li class="nav-item">
                                        <a href="{{ route('tag.create') }}" class="nav-link">Create a new
                                            Tage</a>
                                    </li>
                                @endif
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="post">
                            <ul class="nav sub-menu">
                                @if (auth()->user()->role === 'admin')
                                    <li class="nav-item">
                                        <a href="{{ route('posts.create') }}" class="nav-link">Create a new
                                            category</a>
                                    </li>
                                @endif

                                <li class="nav-item">
                                    <a href="{{ route('posts.index') }}" class="nav-link">All category</a>
                                </li>
